# -*- coding: utf-8 -*-
"""精确计算鲅鱼+VD3版的29项NRC指标，用于生成文档"""
import sys, io
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

# 鲅鱼 = USDA "Fish, mackerel, spanish, raw"
spanish = {
...
supp = {
    ...
    'VB1': 0.5 * 50, 'VB2': 0.5 * 50, 'VB3': 0.5 * 50,
    'VB6': 0.5 * 50, 'VB12': 0.5 * 50,
    '牛磺酸': 3000,
    '氯化物': 3 * 0.6066 * 1000,
    '叶酸': 0.5 * 400, '泛酸': 0.5 * 50,
}
...
for name, low, high, unit in checks:
    ...
    if ok: nrc_pass += 1
    status = '✅' if ok else '❌'
    print(f'| {name} | {value:.1f} {unit}/1000kcal | {status} |')
...
print(f'每日热量: A={da:.1f}, B={db:.1f}, C={dc:.1f}, total={da+db+dc:.1f}')
