...
supp = {
    ...
    '铁': 0.5 * 36,             # 螯合铁 0.5粒 × 36mg
    '锌': 0.5 * 30,             # 锌片 0.5粒 × 30mg
    '锰': 0.5 * 10,             # 锰片 0.5粒 × 10mg
    '碘': 7 * 225 + 3 * 25,     # 海带碘7粒 + 碘盐3g(~25mcg/g)
    '钠': 3 * 0.3934 * 1000,    # 碘盐3g → Na
    'VE': 2 * 100 * 0.6711,     # 2粒×100IU, 1IU=0.6711mg
...
doc_values = {
    'A_7%鸡皮+鲅鱼': {
        ...
        'nrc': {
            ...
            '铁': 20.3, '锌': 19.6, '铜': 3.0, '锰': 1.3,
            '碘': 387.3, '硒': 174.5, '牛磺酸': 821.3,
            'VA': 6882.1, 'VD': 372.8, 'VE': 31.4,
            'VB1': 7.0, 'VB2': 8.7, 'VB3': 41.5,
            'VB6': 7.6, 'VB12': 40.2, '胆碱': 763.0,
            '叶酸': 362.9, '泛酸': 16.6, '花生四烯酸': 606.4,
    ...
    'B_7%鸡皮+鸭胸+鲅鱼': {
        ...
        'nrc': {
            ...
            '铁': 21.9, '锌': 19.3, '铜': 3.2, '锰': 1.3,
            '碘': 379.5, '硒': 159.9, '牛磺酸': 785.0,
            'VA': 6782.4, 'VD': 370.3, 'VE': 31.3,
            'VB1': 7.2, 'VB2': 8.9, 'VB3': 40.7,
            'VB6': 7.5, 'VB12': 39.4, '胆碱': 746.6,
            '叶酸': 379.3, '泛酸': 17.0, '花生四烯酸': 532.1,
    ...
    'C_鸭胸强化+鲅鱼': {
        ...
        'nrc': {
            ...
            '铁': 22.6, '锌': 19.2, '铜': 3.2, '锰': 1.3,
            '碘': 374.7, '硒': 152.8, '牛磺酸': 765.5,
            'VA': 6715.6, 'VD': 368.1, 'VE': 31.3,
            'VB1': 7.3, 'VB2': 9.0, 'VB3': 40.3,
            'VB6': 7.4, 'VB12': 38.9, '胆碱': 738.0,
            '叶酸': 386.3, '泛酸': 17.2, '花生四烯酸': 495.8,
