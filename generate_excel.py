...
SUPP_ITEMS = [
    ...
    ('维生素E 100IU×2',    '2粒',    {'VE(mg)': 2*100*0.6711}),
    ('维生素B族 B-50',     '0.5片',  {'VB1(mg)': 0.5*50, 'VB2(mg)': 0.5*50, 'VB3(mg)': 0.5*50,
                                      'VB6(mg)': 0.5*50, 'VB12(mcg)': 0.5*50,
                                      '叶酸(mcg)': 0.5*400, '泛酸(mg)': 0.5*50}),
    ('海带碘 225mcg×7',    '7粒',    {'碘(mcg)': 7*225}),
    ('碘盐',               '3g',     {'碘(mcg)': 3*25, '钠(mg)': 3*0.3934*1000,
                                      '氯化物(mg)': 3*0.6066*1000}),
    ('锌片 30mg',          '0.5粒',  {'锌(mg)': 0.5*30}),
    ('螯合铁 36mg',        '0.5粒',  {'铁(mg)': 0.5*36}),
    ('锰片 10mg',          '0.5粒',  {'锰(mg)': 0.5*10}),
]
