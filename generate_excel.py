...
NUT_MATRIX = {
    ...
    '叶酸(mcg)':     [6,     1,     72,    3,     47,    588,   290,   2,      1,     5],
    '泛酸(mg)':      [1.01,  0.60,  2.51,  2.25,  1.53,  6.50,  7.17,  0.42,   0.53,  1.03],
}
...
def create_version_sheet(wb, ver_name, ver_data):
    ...
    r = 2
    ws.cell(row=r, column=1, value='基于 NRC 2006 · 鲅鱼体系 · 每批额外补1粒VD3').font = Font(name='微软雅黑', size=10, color='666666')
